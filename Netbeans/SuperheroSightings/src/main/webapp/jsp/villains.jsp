                                                ...
                                                <c:when test="${display == 'edit'}">
                                                    ...
                                                    <div>
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li>If the villain's organization is not available in the dropdown,
                                                ...
                                                <c:when test="${display == 'view'}">
                                                    ...
                                                    <div>
                                                        <table class="table-condensed table">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <a href="${pageContext.request.contextPath}/viewHeroes?viewType=edit&characterId=${villain.characterId}" class="btn btn-danger viewButtons">Edit Hero</a>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                            ...
                                            <c:choose>
                                                ...
                                                <c:otherwise>
                                                    <form action="createHero" class="displayForm" method="POST">
                                                        ...
                                                        <button class="btn btn-primary" id="newVillain"> Submit Villain </button>
                                                    </form>
                                                </c:otherwise>
                                            </c:choose>
                                        </div> </div>
