 ...
 */
public class LocationsDaoUnitTest {
    ...
    public void testAddLocation() throws ParseException {
        ...
        //Assert
        assert myLocation.getLocationID() != 0;
        assert myLocation.getZip().equals("90210");
        assert myLocation.getLocationName().equals("The Bat Cave");
        assert myLocation.getStreetNumber().equals("447");
        assert myLocation.getStreetName().equals("Grand");
        assert myLocation.getLatitude().equals(36.778259);
        assert myLocation.getLongitude().equals(-119.417931);
        assert myLocation.getDescription().equals("The best location");
        assert myLocation.getCity().equals("Los Angeles");
...
//
//        //Assert
        assert myLocation.getLocationID() == myLocation.getLocationID();
        assert myLocation.getLocationName().equals(daoLocation.getLocationName());
        assert myLocation.getDescription().equals(myLocation.getDescription());
        assert myLocation.getCity().equals(myLocation.getCity());
        assert myLocation.getStreetNumber().equals(myLocation.getStreetNumber());
        assert myLocation.getStreetName().equals(myLocation.getStreetName());
        assert myLocation.getState().equals(myLocation.getState());
        assert myLocation.getZip().equals(myLocation.getZip());
