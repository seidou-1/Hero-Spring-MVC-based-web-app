                ...
                <div id="heroForm">
                    ...
                    <div class="col-md-6" id="createHeroForm">
                        ...
                        <c:choose>
                            <c:when test="${display == 'view'}">
                                <ul>
                                    <li>Name: <br><c:out value="${hero.name}"></c:out></li>
                                    <li>Description: <br><c:out value="${hero.description}"></c:out></li>
                                    <li>Super Power: <br><c:out value="Ud"></c:out></li>
                                    <li>Organizations: <br><c:out value="${hero.orgList}"></c:out></li>
                                </ul>
